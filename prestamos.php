...
<head>
	<title>Prestamos | Credinieto</title>
	<?php
		...
		<div id="main-content-wrapper" class="content-wrapper ">
			...
			<div class="content">
				<div class="main-header">
					<h2>Prestamos</h2>
					<em>pagina para registro de prestamos</em>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3><i class="fa fa-table"></i> Prestamos</h3> <em> -  pagina para registro de prestamos</em></div>
...
INNER JOIN
	clientes
ON
	creditos.id_cliente = clientes.id_clientes;",$link) or die (mysql_error());
