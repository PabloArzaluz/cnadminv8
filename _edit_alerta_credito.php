<?php
	...
	if(!isset($_SESSION['id_usuario'])){
		...
		$actualizar_alerta_credito = "UPDATE alerta_credito SET fechaAlerta='$fechaAlerta', comentario='$comentarios' WHERE idAlertaCredito= $idAlerta;";
		$iny_actualizar_alerta_credito = mysqli_query($mysqli,$actualizar_alerta_credito) or die ('Unable to execute query. '. mysqli_error($mysqli));
