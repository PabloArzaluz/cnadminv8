...
<head>
	<title>Prestamos ISSEG | Credinieto</title>
	<?php
		...
		<div id="main-content-wrapper" class="content-wrapper ">
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Prestamos ISSEG</li>
					</ul>
				</div>
			...
			<div class="content">
				<div class="main-header">
					<h2>Prestamos ISSEG</h2>
					<em>filtro de creditos ISSEG</em>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3><i class="fa fa-table"></i> Prestamos ISSEG</h3> <em> -  pagina de creditos ISSEG</em></div>
...
INNER JOIN
	clientes
ON
	creditos.id_cliente = clientes.id_clientes WHERE creditos.isseg=1;",$link) or die (mysql_error());
