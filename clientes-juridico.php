		...
		<div id="main-content-wrapper" class="content-wrapper ">
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Clientes en Juridico</li>
					</ul>
				</div>
			...
			<div class="content">
				<div class="main-header">
					<h2>Clientes</h2>
					<em>clientes con algun credito en juridico</em>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3><i class="fa fa-table"></i> Clientes</h3> <em> -  clientes en juridico</em></div>
						<div class="widget-content">
							...
							<table id="featured-datatable" class="table table-sorting table-hover datatable">
								...
								<tbody>
									...
									<?php
										//Consulta Cientes
										$iny_clientes = mysqli_query($mysqli,"select * from clientes where id_clientes in(select distinct id_cliente from creditos where status=3);") or die (mysqli_error());
										if(mysqli_num_rows($iny_clientes) > 0){
							              while($row = mysqli_fetch_array($iny_clientes)){
											...
											echo "<td> <a href='cliente-profile.php?id=$row[0]'>$nombre_completo";
