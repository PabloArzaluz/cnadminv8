<?php
	...
	$pagina_actual = "prestamos-vendidos";
	//Validar Permisos
...
<head>
	<title>Prestamos Vendidos | Credinieto</title>
	<?php
		...
		<div id="main-content-wrapper" class="content-wrapper ">
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Prestamos Vendidos</li>
					</ul>
				</div>
			...
			<div class="content">
				<div class="main-header">
					<h2>Prestamos Vendidos</h2>
					<em>filtro de creditos vendidos</em>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3><i class="fa fa-table"></i> Prestamos Vendidos</h3> <em> -  pagina de creditos vendidos</em></div>
