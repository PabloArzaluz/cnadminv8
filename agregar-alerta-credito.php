...
<head>
	<title>Agregar Alerta Credito | Credinieto</title>
			...
			<div class="row">
							<div class="col-lg-4 ">
								<ul class="breadcrumb">
									...
									<li class="active">Agregar Alerta Credito</li>
								</ul>
							</div>
				...
				<div class="main-content">
					...
					<div class="widget">
						<div class="widget-header">
							...
							<h3><i class="fa fa-edit"></i> Agregar Alerta a un Credito</h3></div>
						<div class="widget-content">
						<form class="form-horizontal" role="form" name="formModifCredi" method="post" action="_agregar_alerta_credito.php" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												...
												<input type="text" id="datepicker" class="form-control" name="fecha-alerta" required placeholder="Fecha Inicial (Año/Mes/Dia)">
											</div>
										</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="input-group">
												<textarea class="form-control textarea-with-counter" placeholder="Comentarios" name="comentarios" required rows="6" cols="100"></textarea>
											</div>
										</div>
