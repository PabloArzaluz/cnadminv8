...
<head>
	<title>Vender Credito | Credinieto</title>
	<?php
		...
		<div id="main-content-wrapper" class="content-wrapper ">
			<div class="row">
							<div class="col-lg-4 ">
								<ul class="breadcrumb">
									...
									<li class="active">Vender Creditos</li>
								</ul>
							</div>
			...
			<div class="content">
				<div class="main-header">
					...
					<em>formulario para venta de credito</em>
				</div>
				<div class="main-content">
					...
					<div class="widget">
						<div class="widget-header">
							...
							<h3><i class="fa fa-edit"></i> Venta de Credito</h3></div>
						<div class="widget-content">
							<div class="row">
                                <form class="form-horizontal" role="form" method="post" action="_vender_credito.php" enctype="multipart/form-data">
                                    <?php
                                        $id_credito = $_GET['id'];
								...
								<div class="col-md-12">
                                        <div class="form-group">
											<label class="col-md-3 control-label" for="tipo-pago">Estas a punto de realizar la venta del credito con la siguiente informacion: </label>
											<div class="col-md-9">
										...
										<input type="hidden" name="status" value="<?php echo $row_credito[5]; ?>">
								</div>
							</div>
							<div class="row">
								<div class="form-group">
                                    <div class="col-sm-offset-8 col-sm-4">
                                        <a href="detalle-credito.php?id=<?php echo $id_credito; ?>" class="btn btn-default">Cancelar</a> <button type="submit" class="btn btn-success">Vender Credito</button>
                                    </div>
                                </div>
							</div>
							</form>
