<?php
	...
	$pagina_actual = "prestamos-juridico";
	//PERMISOS
...
<head>
	<title>Prestamos en Juridico | Credinieto</title>
	<?php
		...
		<div id="main-content-wrapper" class="content-wrapper ">
			<div class="row">
				<div class="col-lg-4 ">
					<ul class="breadcrumb">
						...
						<li class="active">Prestamos en Juridico</li>
					</ul>
				</div>
			...
			<div class="content">
				<div class="main-header">
					<h2>Prestamos en Juridico</h2>
					<em>filtro de creditos en juridico</em>
				</div>
				...
				<div class="main-content">
					...
					<div class="widget widget-table">
						<div class="widget-header">
							<h3><i class="fa fa-table"></i> Prestamos en Juridico</h3> <em> -  pagina para registro de prestamos</em></div>
...
INNER JOIN
	clientes
ON
	creditos.id_cliente = clientes.id_clientes WHERE creditos.status = 3;",$link) or die (mysql_error());
										if(mysql_num_rows($iny_clientes) > 0){
							              while($row = mysql_fetch_array($iny_clientes)){
							                echo "<tr>
							                <td>".$row[9]."</td>
											<td> ".$row[1]." ".$row[2]." ".$row[3];
											categoriaClienteHTML($row[10]);
											echo "</td>
